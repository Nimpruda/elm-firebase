		...
		[
			...
			_List_fromArray(
				[
					...
					function (_n0) {
						return A2(elm_explorations$test$Expect$equal, 1, 1);
					})
				]))
		]));
...
var author$project$Test$Generated$Main3000476633$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/khalil/elm-firebase/tests/Example.elm']),
		processes: 16,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 238916883686154
	},
...
_Platform_export({'Test':{'Generated':{'Main3000476633':{'init':author$project$Test$Generated$Main3000476633$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-12040.sock";
